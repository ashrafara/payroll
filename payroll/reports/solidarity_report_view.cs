...
{
    public partial class solidarity_report_view : Form
    {
        public solidarity_report_view()
        {
            InitializeComponent();
        }

        private void solidarity_report_view_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                solidarity_report rpt = new solidarity_report();
